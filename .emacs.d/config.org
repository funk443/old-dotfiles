...
- [[#functions][Functions]]
  ...
  - [[#switch-buffer-visibility-in-ibuffer][Switch Buffer Visibility in ibuffer]]
...
(defun set-fonts ()
  ...
  (dolist (face '((org-level-1 . 1.3)
                  ...
                  (org-level-7 . 1.0)
                  (org-level-8 . 1.0)))
    (set-face-attribute (car face) nil :font "ShareTech-12" :height (cdr face))))
#+end_src

** Switch Buffer Visibility in ibuffer
#+begin_src elisp
(defun switch-ibuffer-visibility ()
  (interactive)
