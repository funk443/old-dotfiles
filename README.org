...
what does what, feel free to check out [[file:.emacs.d/init.org][init.el]].
there's also this [[file:.emacs.d/config.org][old config]] I used to use, it's
deprecated now, but still has some information in it.
